...
int main(void)
{
  ...
  int socket_desc = socket(AF_INET, SOCK_STREAM, 0); //(domain,type,protocol)
  ...
  */
  ...
  //wait at recieve
  char client_message[2000] = "Hello from client";
  char server_message[2000] = "Hello from server";
